...
if(isset($_POST["q43"]) && isset($_POST["q44"]) && isset($_POST["q45"] ) && isset($_POST["q46"]) && isset($_POST["q47"]) && isset($_POST["q48"]) ) {

	$t8 = array( $_POST["q43"], $_POST["q44"], $_POST["q45"], $_POST["q46"], $_POST["q47"], $_POST["q48"] );
	$test8 = array_sum($t8);
	//echo $test8;
	//echo "<br/>";
	//echo $_SESSION["test7"];
